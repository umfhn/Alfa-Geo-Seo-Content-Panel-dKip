...
import type { AcfFieldGroup } from '../../types';
 ...
 * for setting up the required fields in WordPress. The output is an array of field groups,
 * ready for direct import into ACF.
 * @returns An array of AcfFieldGroup objects.
 */
export const buildAcfJson = (): AcfFieldGroup[] => {
    return [
        {
            key: 'group_dkip_page_content',
